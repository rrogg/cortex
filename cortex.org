...
(use-package org
  :config
  (setq org-agenda-files '("~/org/refile.org" "~/org/agenda-settings.org" "~/org/work/work.org" "~/org/private/private.org"))
...
'(<<my-work-agenda-key-desc>>
  (<<my-agenda-cmd-agenda>>
   ...
   <<my-agenda-cmd-project-plan>>
   <<my-agenda-cmd-waiting>>)
  ((org-agenda-files '("~/org/refile.org" "~/org/agenda-settings.org" "~/org/work/work.org"))))
#+END_SRC
...
'(<<my-private-agenda-key-desc>>
  (<<my-agenda-cmd-agenda>>
   ...
   <<my-agenda-cmd-project-plan>>
   <<my-agenda-cmd-waiting>>)
  ((org-agenda-files '("~/org/refile.org" "~/org/agenda-settings.org" "~/org/private/private.org"))))
#+END_SRC
